      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Explore a selection of my projects showcasing data analysis, strategic intelligence, and domain investment work.
          </p>
        </motion.div>
        ...
        <div className="flex justify-center mb-12">
          <div className="flex flex-wrap gap-2 bg-background p-1 rounded-full">
            ...
            <Button 
              variant={filter === "data" ? "default" : "ghost"} 
              className={cn(
                "rounded-full",
                filter === "data" ? "" : "hover:bg-secondary"
              )}
            ...
            <Button 
              ...
              className={cn(
                "rounded-full",
                filter === "strategy" ? "" : "hover:bg-secondary"
              )}
            ...
            <Button 
              variant={filter === "domains" ? "default" : "ghost"} 
              className={cn(
                "rounded-full",
                filter === "domains" ? "" : "hover:bg-secondary"
              )}
